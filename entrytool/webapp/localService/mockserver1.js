sap.ui.define([
    ...
    var oMockServer,
        ...
        _sJsonFilesModulePath = _sAppModulePath + 'localService/mockdata1';
    ...
    return {
        ...
        init: function () {
            var oUriParameters = jQuery.sap.getUriParameters(),
                ...
                sEntity = 'ysaleAreaInputSet',
                sEntity2 = 'ycustomervalidationSet',
            ...
            // });
            oMockServer.simulate("../localService/YSD_MOET_SRV.xml", {
				sMockdataBaseUrl: "../localService/mockdata1",
				bGenerateMissingMockData: true
			});
